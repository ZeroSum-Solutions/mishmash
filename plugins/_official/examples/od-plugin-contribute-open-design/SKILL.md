...
description: Open a pull request adding a local MishMash plugin to the MishMash community catalog using gh CLI.
triggers:
  - contribute plugin
  - open design pr
  - github pull request
...
# Contribute Plugin to MishMash

Use this workflow when the active project contains a copied plugin folder and the user wants to propose it for the MishMash community catalog.
...
Keep the pull request focused. Do not modify unrelated MishMash files unless a manifest validation issue requires a tiny supporting change.
