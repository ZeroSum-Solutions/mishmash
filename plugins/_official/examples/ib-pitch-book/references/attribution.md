...
The MishMash skill bundle (`SKILL.md`, `example.html`, `assets/template.html`,
and references in this folder) is contributed under MishMash's repository
