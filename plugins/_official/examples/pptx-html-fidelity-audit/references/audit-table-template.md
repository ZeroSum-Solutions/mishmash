...
|---|---|---|
| 1 cover     | meta-row bottom edge at 6.95" overlaps the footer (6.7")   | 🔴 |
| 2 principle | meta-row overlaps the footer                                | 🔴 |
| 5 checklist | row B step description bottom edge cuts into the footer at 7.2" | 🔴 |
| 8 3E        | closing paragraph sits directly at the footer's start point | 🔴 |
| 9 on-day    | step description bottom edge just touches the footer, no safety margin | 🟠 |
| 10 obs      | row 2 obs-card bottom edge cuts the footer at 6.95"         | 🔴 |
| 11 P&D      | Note paragraph bottom edge at 7.34" sits entirely below the footer | 🔴 |
| 13 deliv.   | pipeline description bottom edge cuts the footer at 7.05"   | 🔴 |
| 14 closing  | meta-row bottom edge at 7.24" spills past the footer         | 🔴 |
| multiple    | em (Playfair italic) and special font-size contrast not preserved | 🟡 |
