...
example_desc: "Senior frontend engineer resume, two-column layout, highlighted numeric achievements"
od:
  mode: prototype
  surface: web
  platform: desktop
...
- Each experience entry: company + title + date range (right-aligned), followed by 1-3 bullets starting with a verb.
- No flashy colors — black/white/gray + 1 accent (deep blue / dark green).
- Add `@media print` styles, hiding unnecessary elements while keeping colors.
