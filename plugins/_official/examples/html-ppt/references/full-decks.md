...
- **Source inspiration:** `20260409-knowledge-base-v2/image-text-cards/v2-white-bg/slide_01_cover.html` + `20260412-ai-testing-and-safety/html/xhs-ai-testing-safety-v2.html`
...
- **When to use:** dual-purpose image-card + horizontal deck; dense text with strong emphasis; editorial lifestyle content.
- **Path:** `templates/full-decks/xhs-white-editorial/index.html`

## 2. graphify-dark-graph — dark-background knowledge graph
...
- **Source inspiration:** `20260405-karpathy-knowledge-base/20260405-architecture-diagram-v2.html`
...
- **Source inspiration:** `20260412-ai-testing-and-safety/html/xhs-ai-testing-safety-v2.html`
...
## 7. xhs-pastel-card — soft macaron slow-living

- **Source inspiration:** `20260412-obsidian-skills/html/xhs-obsidian-skills.html` + pastel patterns shared with `20260409` white-bg v2
...
## 8. dir-key-nav-minimal — arrow-key 8-color minimalist

- **Source inspiration:** `20260405-karpathy-knowledge-base/20260405-demo-slides-arrow-key-edition.html`
...
| 11 | `tech-sharing`     | 8  | GitHub-dark, JetBrains Mono, terminal code blocks, agenda + Q&A | Internal tech talk, conference talk |
| 12 | `weekly-report`    | 7  | Corporate clarity, 8-cell KPI grid, shipped list, 8-week bar chart, next-week table | Team status update, business review |
| 13 | `course-module`    | 7  | Warm paper + Playfair serif, persistent left sidebar of learning objectives, MCQ self-check | Online course, workshop module |
| 14 | `presenter-mode-reveal` 🎤 | 6  | **Presenter-mode showcase** · tokyo-night default · 5 themes, cycle with `T` · each slide ships a 150–300 word speaker-notes script | **Tech talk / conference talk / course** — any scene where you need `S` to reveal speaker notes ✨ |

Each folder: `index.html`, scoped `style.css` (prefixed `.tpl-<name>`), `README.md`.

> 🎤 **Any presenting scenario (tech talk / course / roadshow) should default to `presenter-mode-reveal`**, or follow the [presenter-mode.md](./presenter-mode.md) guide to add a `<aside class="notes">` speaker-notes script to another template.
