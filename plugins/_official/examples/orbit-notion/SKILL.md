...
- Same H2 sections in the same order (Document Changes → Comments / Mentions → Database Changes)
...
4. **Page header inside content column** — emoji icon (60px) at top,
   then page title `Morning Briefing · May 6, 2026 (Wed)` in 40px bold,
...
8. **Callout block** — required. `gray bg`, 16px padding, rounded 6px,
   ...
   *"Eli, you still have 3 unanswered comments from yesterday — take a look before Wednesday's meeting?"*
...
11. **Closing callout** — second callout at the bottom acting as a CTA:
    `🚀 Continue in Open Design →` linked back to the OD project.
...
| Use lorem ipsum | Write real-shaped Notion copy: doc titles like `Q3 OKR`, `Onboarding Doc`, `Team Weekly Report`; people like Marie / Bob / Lily; comments like "this section needs your confirmation" |
