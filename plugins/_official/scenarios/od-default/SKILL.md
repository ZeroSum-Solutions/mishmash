---
name: od-default
description: Hidden fallback scenario for free-form Home prompts. Ask the task type first, then continue through the matching MishMash flow.
od:
...
{
  "lang": "en",
  "description": "I'll route this through the right MishMash workflow and lock the brief in one shot. Prefilled for you — send as is, or adjust first.",
  "questions": [
    {
      "id": "taskType",
...
- `Other`: ask only the minimum follow-up needed, then choose the closest
  MishMash workflow and continue.
