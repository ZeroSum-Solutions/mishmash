...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/aura-email-landing"
...
```
<artifact identifier="aura-email-landing" type="text/html" title="Aura — AI-Native Email Client Landing Page">
<!doctype html>
<html>...</html>
</artifact>
```
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/aura-email-landing).
