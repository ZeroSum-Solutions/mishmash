...
(function () {
  ...
  ready(function () {
    ...
    function openPresenterWindow() {
      ...
      if (!presenterWin) {
        alert('Please allow pop-ups to use presenter view');
        return;
      }
...
<div id="stage">
  ...
  <div class="pcard pcard-notes" id="card-notes" style="--dot-color:#f0883e">
    <div class="pcard-head" data-drag>
      <span class="pcard-dot"></span>
      <span class="pcard-title">SPEAKER SCRIPT</span>
    </div>
...
<div class="hint-bar">
  <span><kbd>← →</kbd> change slide</span>
  <span><kbd>R</kbd> reset timer</span>
  <span><kbd>Esc</kbd> close</span>
  <span style="color:#6e7681">Drag the card header to move · drag the bottom-right corner to resize</span>
...
(function(){
  ...
  function update(n) {
    ...
    notesBody.innerHTML = note || '<span class="empty">(no speaker notes for this slide yet)</span>';
  ...
  document.getElementById('reset-layout').addEventListener('click', function(){
    if (confirm('Restore the default card layout?')) {
  ...
  notesBody.innerHTML = slideMeta[idx].notes || '<span class="empty">(no speaker notes for this slide yet)</span>';
