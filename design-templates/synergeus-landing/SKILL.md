---
name: synergeus-landing
description: |
  **Synergeus** is a pixel-faithful dark, cinematic marketing landing page for an AI-powered personal finance platform. The page is composed of three scroll-revealed sections — a video hero, an analytics showcase, and an AI intelligence feature grid — with meticulous attention to typography, motion timing, glass surfaces, and SVG construction. A striking fintech UI landing page suited to AI advisor, wealth management, and financial SaaS products.
tags:
  - "landing-page"
  - "landing-pages"
  - "claude-directory"
...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/synergeus-landing"
  ...
  scenario: "marketing"
  example_prompt: "Build Synergeus — AI Fintech Landing Page as a self-contained responsive page in this template's own visual system. Follow the build spec in this skill exactly — palette, typography, section order, and motion are part of the identity. Ask only for the missing essentials first: brand name, real copy, and any imagery to swap in."
---

# Synergeus — AI Fintech Landing Page
...
```
<artifact identifier="synergeus-landing" type="text/html" title="Synergeus — AI Fintech Landing Page">
<!doctype html>
<html>...</html>
</artifact>
```
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/synergeus-landing).
