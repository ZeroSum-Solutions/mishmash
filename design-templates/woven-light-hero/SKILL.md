...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/woven-light-hero"
  ...
  scenario: "marketing"
  example_prompt: "Build Woven by Light — Interactive GPU Particle Hero Section as a self-contained responsive page in this template's own visual system. Follow the build spec in this skill exactly — palette, typography, section order, and motion are part of the identity. Ask only for the missing essentials first: brand name, real copy, and any imagery to swap in."
---

# Woven by Light — Interactive GPU Particle Hero Section
...
```
<artifact identifier="woven-light-hero" type="text/html" title="Woven by Light — Interactive GPU Particle Hero Section">
<!doctype html>
<html>...</html>
</artifact>
```
...
# WOVEN LIGHT HERO — COMPONENT INTEGRATION
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/woven-light-hero).
