...
name: rivr-defi-hero
description: |
  A hero section for the fictional DeFi dashboard **RIVR**, built to an exact glassmorphism spec: a full-bleed video background inside a rounded, inset frame, frosted-glass badge and stat card, and a faux-cutout "Documentation" corner achieved with inverted-radius SVG masks. Entrance animations and micro-interactions are driven by the `motion/react` library, making this an ideal reference for premium DeFi or Web3 landing pages with a clean, modern UI.
tags:
  - "hero-section"
  - "hero-sections"
  - "claude-directory"
...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/rivr-defi-hero"
  ...
  category: "component"
  scenario: "marketing"
  example_prompt: "Build RIVR — DeFi Dashboard Glassmorphism Hero Section as a self-contained responsive page in this template's own visual system. Follow the build spec in this skill exactly — palette, typography, section order, and motion are part of the identity. Ask only for the missing essentials first: brand name, real copy, and any imagery to swap in."
---

# RIVR — DeFi Dashboard Glassmorphism Hero Section
...
```
<artifact identifier="rivr-defi-hero" type="text/html" title="RIVR — DeFi Dashboard Glassmorphism Hero Section">
<!doctype html>
<html>...</html>
</artifact>
```
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/rivr-defi-hero).
