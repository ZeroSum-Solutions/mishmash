...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/sentinel-ai-hero"
  ...
  scenario: "marketing"
  example_prompt: "Build SENTINEL AI — Dark Security Hero Section with Interactive 3D Spline Background as a self-contained responsive page in this template's own visual system. Follow the build spec in this skill exactly — palette, typography, section order, and motion are part of the identity. Ask only for the missing essentials first: brand name, real copy, and any imagery to swap in."
---

# SENTINEL AI — Dark Security Hero Section with Interactive 3D Spline Background
...
```
<artifact identifier="sentinel-ai-hero" type="text/html" title="SENTINEL AI — Dark Security Hero Section with Interactive 3D Spline Background">
<!doctype html>
<html>...</html>
</artifact>
```
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/sentinel-ai-hero).
