...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/ai-builder-dark-hero"
...
# AI Builder Dark Hero — Dark-Mode AI Website Builder Hero Section
...
```
<artifact identifier="ai-builder-dark-hero" type="text/html" title="AI Builder Dark Hero — Dark-Mode AI Website Builder Hero Section">
<!doctype html>
<html>...</html>
</artifact>
```
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/hero-sections/ai-builder-dark-hero).
