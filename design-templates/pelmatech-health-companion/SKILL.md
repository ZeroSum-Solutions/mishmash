---
name: pelmatech-health-companion
description: |
...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/pelmatech-health-companion"
...
```
<artifact identifier="pelmatech-health-companion" type="text/html" title="Pelmatech — Personal Health Companion Landing Page">
<!doctype html>
<html>...</html>
</artifact>
```
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/pelmatech-health-companion).
