...
od:
  mode: prototype
  platform: desktop
  upstream: "https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/groundai-landing"
...
```
<artifact identifier="groundai-landing" type="text/html" title="GroundAI — Interior Design AI Landing Page">
<!doctype html>
<html>...</html>
</artifact>
```
...
[`pulkitxm/claude-directory`](https://github.com/pulkitxm/claude-directory/tree/main/landing-pages/groundai-landing).
