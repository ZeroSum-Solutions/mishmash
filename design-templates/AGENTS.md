...
footage and rewrites its local `@font-face` rules onto the Google Fonts CDN;
a hand edit is lost on the next import. That script's header documents the
build prerequisites, the two bake strategies, and the media budgets.
