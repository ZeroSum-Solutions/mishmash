  ...
  it('confirms a plugin share action before starting the GitHub repo task', async () => {
    mockedListPlugins.mockResolvedValue([
      ...
      makePlugin(
        ...
        'Creates a public GitHub repository for a local MishMash plugin using the GitHub CLI.',
      ),
      makePlugin(
        ...
        'Opens a pull request that adds a local MishMash plugin to the MishMash community catalog.',
      ),
    ]);
