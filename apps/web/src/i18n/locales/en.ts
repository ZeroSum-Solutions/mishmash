...
export const en: Dict = {
  ...
  'fileViewer.previewInlineFallbackTitle': 'Preview may be blank',
  'fileViewer.previewInlineFallbackDetail': 'This artifact loads a script at runtime. The sandboxed preview blocks that script from reading browser storage, which can leave the canvas empty. Render it inline to give the script the storage shim.',
  'fileViewer.previewInlineFallbackAction': 'Render inline',
