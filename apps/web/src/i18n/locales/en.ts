...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to MishMash Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to MishMash Cloud & retry',
  'chat.amrError.authMessage': 'Your MishMash Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your MishMash Cloud balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with MishMash Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the MishMash Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.title.cliOutdated': 'Agent version too old',
  'chat.runError.title.attachmentUnsupported': 'Attachment not supported',
  'chat.runError.title.requestRejected': 'Request rejected',
  'chat.runError.title.toolFailed': 'A tool step failed',
  'chat.runError.title.agentDidNotStart': 'Agent could not start',
  'chat.runError.title.agentStopped': 'Agent stopped with an error',
  'chat.runError.title.agentCrashed': 'Agent crashed',
  ...
  'chat.runError.title.daemonRestarted': 'Interrupted by a restart',
  ...
  'chat.runError.daemonRestartedMessage': 'MishMash restarted while this turn was running, so the turn stopped before it finished. Nothing about your request was wrong — retry to run it again.',
  ...
  'chat.runError.step.modelSelect': 'It failed while selecting the model.',
  'chat.runError.step.promptSend': 'It failed while sending your prompt.',
  'chat.runError.step.firstTokenWait': 'It failed while waiting for the first response.',
  'chat.runError.step.toolExecution': 'It failed while the agent was running a tool.',
  'chat.runError.step.artifactWrite': 'It failed while writing your files.',
  'chat.runError.step.childClose': 'It failed while the agent was responding.',
  'chat.runError.step.finalize': 'It failed while finishing the run.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update MishMash to the latest version, which ships a compatible runtime.",
  'common.cancel': 'Cancel',
  'chat.selectFromLibrary': 'Import from Assets',
  ...
  'designFiles.library.label': 'Import from Assets',
  'designFiles.library.title': 'Import from Assets',
  'libraryPicker.title': 'Import from Assets',
  'libraryPicker.searchPlaceholder': 'Search Assets…',
  'libraryPicker.empty': 'No assets yet',
  'libraryPicker.allKinds': 'All',
  'libraryPicker.add': 'Import',
  'libraryPicker.loading': 'Loading…',
  'library.assetCount': 'Showing {shown} of {total} assets',
  'library.loadMore': 'Load more',
  'library.loadingMore': 'Loading…',
  'library.rail.allAssets': 'All Assets',
  'library.rail.types': 'Types',
  'library.rail.searchPlaceholder': 'Search Assets…',
  'library.rail.collections': 'Collections',
  'library.rail.collectionsEmpty': 'Create one to stay organized',
  'library.rail.newCollection': 'New collection',
  'library.rail.collectionsUnavailable': 'Collections are coming soon',
  'library.sizeSlider': 'Grid item size',
  'library.expandGrid': 'Expand grid — collapse the assets rail',
  'library.collapseRail': 'Show the assets rail',
  'library.composer.attach': 'Attach a reference image',
  'library.composer.removeAttachment': 'Remove attachment',
  'library.composer.promptPlaceholder': 'Describe any visual idea…',
  ...
  'settings.welcomeTitle': 'Welcome to MishMash',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. MishMash will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. MishMash reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'MishMash Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to MishMash Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the MishMash daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to MishMash.',
  ...
  'settings.amrCloud': 'MishMash Cloud',
  ...
  'settings.amrWalletRefreshTitle': 'Refresh MishMash Cloud wallet balance',
  ...
  'settings.amrAccountStatus': 'MishMash Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose MishMash as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the MishMash team',
  'settings.privacyConsentKicker': 'Help us improve MishMash',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how MishMash performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time MishMash starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but MishMash could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your MishMash projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure MishMash is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in MishMash, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'MishMash must be running for MCP tool calls to succeed. If you started your coding agent before opening MishMash, restart the agent so it can reach the live daemon.',
  ...
  'templates.count': '{shown} of {total}',
  'templates.empty': 'No templates match your search.',
  'templates.sourceAll': 'All',
  'templates.sourceUser': 'Yours',
  ...
  'templates.categoryFilterLabel': 'Filter by category',
  'templates.sectionCount': '{count} templates',
  'templates.category.landingPage': 'Websites & Landing Pages',
  'templates.category.webApp': 'Web Apps',
  'templates.category.dashboard': 'Dashboards',
  'templates.category.deck': 'Deck',
  'templates.category.mobileApp': 'Mobile App',
  'templates.category.docs': 'Docs',
  'templates.category.documentGuide': 'Document Guide',
  'templates.category.email': 'Email',
  'templates.category.prototype': 'Prototype',
  'templates.category.audio': 'Audio',
  'templates.category.videoMotion': 'Video / Motion',
  'templates.category.webgl': 'WebGL',
  'templates.category.icons': 'Icons',
  'templates.category.effect': 'Effect',
  'templates.category.component': 'Component',
  'templates.category.uiKit': 'UI Kit',
  'templates.category.designSystem': 'Design System',
  'templates.category.capture': 'Capture',
  'templates.category.inspiration': 'Inspiration',
  'templates.category.tool': 'Tool',
  ...
  'homeHero.subtitlePrefix': 'The MishMash studio — client-ready websites, decks, and prototypes.',
  ...
  'homeHero.chip.template': 'Build a website',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable MishMash plugin and add it to My plugins.',
  ...
  'homeHero.chip.templateDesc': 'Start from an existing template',
  'homeHero.chip.scrollAnimations': 'Animated scroller',
  'homeHero.chip.scrollAnimationsDesc': 'Scroll-triggered reveals, pins & parallax',
  'homeHero.chip.scrollFilmNext': 'Open a chat that turns your idea into one continuous scroll-driven story.',
  'homeHero.chip.heroCreationNext': 'Open a chat that builds a full-viewport animated hero section.',
  'homeHero.chip.cloneRebrandNext': "Open a chat that clones a site and rebuilds it under your client's brand.",
  'homeHero.chip.scrollAnimationsNext': 'Open a chat that weaves scroll-triggered reveals, pinned sections, and parallax through your site.',
  ...
  'handoff.amrWebsite': 'Visit MishMash Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local MishMash project folder:',
  ...
  'home.workflowsLink.label': 'All workflows & assets',
  ...
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with MishMash and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginsView.tab.gallery': 'Workflows & Assets',
  ...
  'pluginsView.tabHint.gallery': 'Bundled catalog',
  ...
  'pluginsView.galleryTitle': 'Workflows and Assets',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to MishMash',
  'pluginCard.contributeTitle': 'Contribute plugin to MishMash with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to MishMash',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use MishMash from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure MishMash is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'mcpClient.health.check': 'Check health',
  'mcpClient.health.checking': 'Checking…',
  'mcpClient.health.failed': 'Health check failed. Check that the daemon is running and try again.',
  'mcpClient.health.hint': 'Connect state MishMash measured itself, per server. A server reported here as failed does not mean a run failed.',
  'mcpClient.health.stateOk': 'Connected',
  'mcpClient.health.stateFailed': 'Did not start',
  'mcpClient.health.stateTimeout': 'No reply',
  'mcpClient.health.stateDisabled': 'Disabled',
  'mcpClient.health.connectMs': 'Connected in {ms} ms',
  'mcpClient.health.budgetMs': 'No reply within {ms} ms',
  'mcpClient.health.stderrLabel': 'Server output',
  'mcpClient.health.remedyLabel': 'How to fix',
  'mcpClient.health.repair': 'Repair',
  'mcpClient.health.repairPrompt': 'This removes {path}. The server is re-downloaded on the next run.',
  'mcpClient.health.repairConfirm': 'Remove it',
  'mcpClient.health.repairCancel': 'Cancel',
  ...
  'useEverywhere.section.overview.heading': 'MishMash works wherever your agent works',
  'useEverywhere.section.overview.intro': 'MishMash is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires MishMash as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without MishMash at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive MishMash from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose MishMash as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'MishMash ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover MishMash tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the MishMash app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without MishMash running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). MishMash extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside MishMash and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + MishMash extras)',
  ...
  'videoImport.title': 'Video sources',
  'videoImport.subtitle': 'Pull a video you own into a project by link. Vimeo first — YouTube is next.',
  'videoImport.vimeoName': 'Vimeo',
  'videoImport.statusNotConfigured': 'Not configured',
  'videoImport.statusConnectedAs': 'Connected as {name}',
  'videoImport.connecting': 'Connecting…',
  'videoImport.disconnecting': 'Disconnecting…',
  'videoImport.connectError': 'Could not start the Vimeo connection. Try again.',
  'videoImport.disconnectError': 'Could not disconnect Vimeo. Try again.',
  'videoImport.youtubeName': 'YouTube',
  'videoImport.youtubeComingSoon': 'Next, not enabled yet',
  'videoImport.panelTitle': 'Import a video',
  'videoImport.projectLabel': 'Project',
  'videoImport.projectPlaceholder': 'Choose a project…',
  'videoImport.urlLabel': 'Vimeo link',
  'videoImport.urlPlaceholder': 'https://vimeo.com/…',
  'videoImport.providerLabel': 'Source',
  'videoImport.asLabel': 'Save as (optional)',
  ...
  'videoImport.progressWithPercent': '{status} — {percent}%',
  'videoImport.statusQueued': 'Queued',
  'videoImport.statusRunning': 'Downloading',
  'videoImport.statusDone': 'Done',
  'videoImport.statusFailed': 'Failed',
  'videoImport.doneMessage': 'Saved as {name}.',
  'videoImport.jobLoadError': 'Lost track of the import job. Try again.',
  ...
  'newproj.locationDefault': 'MishMash projects',
  ...
  'ds.activeFiltersAria': 'Active filters',
  'ds.clearFilters': 'Clear filters',
  'ds.removeSurfaceFilterLabel': 'Remove filter: {label}',
  ...
  'avatar.amrConsole': 'MishMash Cloud',
  ...
  'socialShare.projectTitle': '{title} · MishMash',
  'socialShare.projectText': 'Built with MishMash: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with MishMash: {title}\n{url}\nMishMash repo: {repo}',
  ...
  'brandEnrichment.body': "MishMash will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask MishMash to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want MishMash to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'designBrowser.reference.kicker': 'MishMash browser',
  ...
  'home.featured.starting': 'Starting…',
  'home.featured.template.dwell.label': 'Dwell',
  'home.featured.template.dwell.descriptor': 'Real-estate site (Next.js)',
  'home.featured.template.morrow.label': 'Morrow',
  'home.featured.template.morrow.descriptor': 'Architecture site (Next.js)',
  'home.featured.template.azurio.label': 'Azurio',
  'home.featured.template.azurio.descriptor': 'Agency/portfolio (HTML)',
  'home.featured.template.core2.label': 'Core 2',
  'home.featured.template.core2.descriptor': 'SaaS dashboard (React)',
  'home.featured.tool.heroCreation.label': 'Hero creation',
  'home.featured.tool.heroCreation.descriptor': 'Full-viewport animated hero section',
  'home.featured.tool.cloneRebrand.label': 'Clone + rebrand',
  'home.featured.tool.cloneRebrand.descriptor': 'Recreate a site under your client\'s brand',
  'home.featured.library.label': 'Browse the kit library',
  'home.featured.library.descriptor': 'All licensed kits & references',
  ...
  'preview.shareToXiaohongshu': 'Xiaohongshu',
  ...
  'preview.shareTextDefault': 'MishMash template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure MishMash is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.documentTemplate.goalBody': 'Describe what MishMash should generate, edit, or decide from this document.',
  ...
  'designFiles.documentTemplate.capabilityAgent': 'The MishMash agent can read, edit, and use this file as project context.',
  ...
  'designFiles.documentTemplate.nextBody': 'Review and edit this document, then ask MishMash to generate, revise, or operate from it.',
  ...
  'designFiles.previewServer.sharedLink': 'Open Design serves this preview itself, so the link opens wherever this workspace opens — with two limits: a page that sends no referrer cannot load its root-absolute assets, and a request body over 4mb is refused.',
  ...
  'designFiles.usefulInfoTip5': 'Out of ideas? Try a plugin template from Workflows and Assets on the Home page.',
  ...
  'designFiles.usefulInfoTip20': 'Follow MishMash on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.compositionMetrics': 'Layout signals',
  'fileViewer.compositionMetricsPanelTitle': 'Rendered layout signals',
  'fileViewer.compositionMetricsEmpty': 'No rendered measurement yet.',
  'fileViewer.compositionMetricsCloneExempt': 'This project reproduces an existing site — layout signals are not tracked for clone runs.',
  'fileViewer.compositionMetricsSections': 'Sections',
  'fileViewer.compositionMetricsOutOfFlow': 'Out-of-flow elements',
  'fileViewer.compositionMetricsTransformed': 'Transformed elements',
  'fileViewer.compositionMetricsBackgrounds': 'Section background colors',
  'fileViewer.compositionMetricsWidths': 'Section widths (distinct)',
  'fileViewer.compositionMetricsFullBleed': 'Full-bleed next to contained',
  'fileViewer.compositionMetricsFontRatio': 'Display:body font ratio',
  ...
  // F-03 named local attribution (W8D).
  'fileViewer.versions.byActor': 'by {name}',
  'fileViewer.versions.unattributed': 'Unattributed',
  'assistant.askedBy': 'Asked by {name}',
  'actorPrompt.title': 'What should we call you?',
  'actorPrompt.description': 'Your name is stamped on the runs and files you create, so your teammates can see who did what. It stays in this browser and is never used to sign you in.',
  'actorPrompt.placeholder': 'Your name',
  'actorPrompt.submit': 'Save',
  'actorPrompt.skip': 'Skip',
  'settings.actorNameLabel': 'Display name',
  'settings.actorNameHint': 'Stamped on the runs and files you create so teammates can see who did what. Stored in this browser only, and never used to sign you in.',
  ...
  'fileViewer.previewUnverifiedTitle': 'Preview not verified',
  'fileViewer.previewUnverifiedDetail': 'Could not verify this preview rendered — it may be blank.',
  'fileViewer.previewUnverifiedRecheck': 'Re-check',
  ...
  'fileViewer.screenshotCapturing': 'Capturing screenshot...',
  'fileViewer.screenshotAddedToChat': 'Screenshot added to chat',
  ...
  'tool.fetch': 'Fetch',
  'tool.search': 'Search',
  'tool.toolSearch': 'Loading tool details',
  'tool.generateImage': 'Generating images',
  'tool.generateVideo': 'Generating video',
  'tool.generateAudio': 'Generating audio',
  'tool.chooseGenerationTool': 'Checking available generation tools',
  'tool.waitForGeneration': 'Waiting for it to finish generating',
  'tool.lines': '{n} lines',
  ...
  'assistant.shareToOpenDesign': 'Share to MishMash',
  ...
  'qf.lockedUnanswered': 'Not answered yet.',
  'qf.answerNow': 'Answer now',
  ...
  'critiqueTheater.settingsStatusHeading': 'Resolved status',
  'critiqueTheater.settingsStatusLoading': 'Checking resolved status…',
  'critiqueTheater.settingsStatusError': 'Could not check resolved status: {error}',
  'critiqueTheater.settingsStatusNoProjectHint': 'Open a project to see its resolved status.',
  'critiqueTheater.settingsStatusEnabledSummary': 'Design Jury will run for new generations in this project.',
  'critiqueTheater.settingsStatusDisabledSummary': 'Design Jury will not run for new generations in this project.',
  'critiqueTheater.settingsStatusApproximateNote': 'This is the rollout-policy answer. A run also needs a matching skill, a resolved design system, and a free adapter slot to actually critique.',
  'critiqueTheater.settingsStatusReasonSkillOptOut': "The project's bound skill opts out of Design Jury, overriding the checkbox above.",
  'critiqueTheater.settingsStatusReasonSkillRequired': "The project's bound skill requires Design Jury, overriding the checkbox above.",
  'critiqueTheater.settingsStatusReasonProjectOverride': 'A project override is set to {value}.',
  'critiqueTheater.settingsStatusReasonEnvOverride': 'An environment override is set to {value}.',
  'critiqueTheater.settingsStatusReasonPhase': 'No override applies; the {phase} rollout phase default decides.',
  'critiqueTheater.settingsStatusDisagreeWarning': 'This differs from the checkbox above — the resolved status wins for new runs.',
  'critiqueTheater.settingsStatusOn': 'on',
  'critiqueTheater.settingsStatusOff': 'off',
  'critiqueTheater.settingsConformanceHeading': 'Fleet conformance',
  'critiqueTheater.settingsConformanceLoading': 'Loading fleet conformance…',
  'critiqueTheater.settingsConformanceError': 'Could not load fleet conformance: {error}',
  'critiqueTheater.settingsConformanceEmpty': 'No conformance data for this window yet.',
  'critiqueTheater.settingsConformanceSummary': '{days}-day window · {shippedPct}% shipped · {cleanPct}% clean parse',
  'critiqueTheater.settingsConformanceDecisionHold': 'Holding at {phase}: {reason}',
  'critiqueTheater.settingsConformanceDecisionPromote': 'Promoted from {from} to {to} ({days} days of evidence)',
  'critiqueTheater.settingsConformanceDecisionDemote': 'Demoted from {from} to {to}: {reason}',
  'pet.title': 'Pets',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with MishMash — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with MishMash — no download needed.',
  ...
  'settings.notifyCompletionSoundHint': 'Plays when a turn finishes. On by default — turn off here to mute it.',
  ...
  'settings.notifyDesktopHint': 'Sent when the window is not focused. Off until you turn it on here.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple MishMash project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions MishMash should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'settings.memoryStarterProjectDesc': 'MishMash v0.5 — chat-driven design editor',
  ...
  'settings.memoryTypeFilterLabel': 'Type',
  'settings.memoryActiveFiltersAria': 'Active filters',
  'settings.memoryClearFilters': 'Clear filters',
  'settings.memoryRemoveTypeFilterLabel': 'Remove filter: {label}',
  ...
  'updater.availableBody': 'MishMash {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'MishMash is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'MishMash could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. MishMash is quitting so you can finish the update.',
  ...
  'updater.payloadReadyGeneric': 'A new MishMash update is ready. MishMash will close and restart automatically.',
  'updater.payloadReadyVersion': 'MishMash {version} is ready. MishMash will close and restart automatically.',
  'updater.quitButton': 'Quit MishMash',
  'updater.quitFailedBody': 'The installer is open, but MishMash could not quit. Quit MishMash before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. MishMash will close and open the installer.',
  'updater.readyVersion': 'MishMash {version} is ready. MishMash will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach MishMash your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions MishMash follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach MishMash your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'MishMash turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'dsCreate.sourceSectionBody': 'Start with a GitHub repo, website, DESIGN.md, or files that show your style. MishMash first creates a usable system quickly, then AI can refine it inside the project.',
  ...
  'dsCreate.libraryPickerTitle': 'Select from Assets',
  ...
  'ds.extractionRunningBody': 'MishMash is updating this system in place.',
  ...
  'ds.repoConnectBannerBody': 'Connect GitHub so MishMash can read your repository and pull colors, type, and components into this design system.',
  ...
  'designLibrary.rightsNote': 'Usage follows RIGHTS.md — when in doubt, treat an item as reference-only.',
  'designLibrary.searchPlaceholder': 'Search collections…',
  'designLibrary.allCategories': 'All categories',
  'designLibrary.allDomains': 'All domains',
  'designLibrary.filesUnit': 'files',
  'designLibrary.filesUnitOne': 'file',
  'designLibrary.openFolder': 'Open file',
  'designLibrary.duplicateOfPrefix': 'Duplicate of',
  'designLibrary.loading': 'Loading design library…',
  'designLibrary.emptyNotFound': 'Design Assets library not found on this machine.',
  'designLibrary.emptyFiltered': 'No collections match your filters.',
  'designLibrary.allowedUse.ownCode': "Devin's code",
  'designLibrary.allowedUse.licensedSourceReview': 'Licensed — adaptable into client work',
  'designLibrary.allowedUse.humanLocalOnly': 'Reference only — never ships, never committed',
  'designLibrary.allowedUse.blockedPendingLicense': 'Blocked — no license record',
  'designLibrary.redistribute.yesLabel': 'Repo-safe',
  'designLibrary.redistribute.noLabel': 'Not for repo',
  'designLibrary.redistribute.yesTooltip': "Devin's own code — may be committed into this repository's tracked tree.",
  'designLibrary.redistribute.noTooltip': "Vendor-licensed or reference-only — must not be committed into this repository's tracked tree.",
  'designLibrary.useAsTemplate': 'Start project',
  'designLibrary.useAsTemplateBusy': 'Starting project…',
  'designLibrary.useAsTemplateError': 'Could not start a project from this kit.',
  'designLibrary.useAsReference': 'Start project',
  'designLibrary.useAsReferenceBusy': 'Preparing design prompt…',
  'designLibrary.useAsReferenceError': 'Could not start a project from this design reference.',
  'designLibrary.aspectsLabel': 'Pick what to carry forward',
  'designLibrary.stacksLabel': 'Suggested stack',
  'designLibrary.fullDesign': 'Full design',
  'designLibrary.selectedAspects': 'selected',
  'designLibrary.preview': 'Preview',
  'designLibrary.previewClose': 'Close',
  'designLibrary.openLivePreview': 'Open live preview',
  'designLibrary.openLivePreviewBusy': 'Opening…',
  'designLibrary.openLivePreviewError': 'Could not open a live preview for this collection.',
  'designLibrary.duplicatesHidden': '{count} duplicates hidden',
  'designLibrary.hoverCarryForwardLabel': 'Could carry forward',
  'designLibrary.previewPrev': 'Previous example',
  'designLibrary.previewNext': 'Next example',
  'designLibrary.previewCounter': '{current} of {total}',
  'designLibrary.exploreKit': 'Explore kit',
  'designLibrary.viewportLabel': 'Canvas width',
  'designLibrary.viewportDesktop': 'Desktop',
  'designLibrary.viewportMobile': 'Mobile',
  'designLibrary.promotions.title': 'Promote a small asset',
  'designLibrary.promotions.policy': 'Small single images or clipped pages up to 3 MB can be promoted here. Kits, folders, .fig, .zip, clones, and bulk sets go in {path}.',
  'designLibrary.promotions.bulkError': 'This is a bulk or unsupported drop. Put it in {path}; nothing was uploaded.',
  'designLibrary.promotions.groupApp': 'App capture',
  'designLibrary.promotions.groupSite': 'Site capture',
  'designLibrary.promotions.groupClone': 'Site clone',
  'designLibrary.promotions.note': 'Optional curator note',
  'designLibrary.promotions.drop': 'Drop one small image or HTML file',
  'designLibrary.promotions.uploading': 'Uploading and requesting promotion…',
  'designLibrary.promotions.queued': 'Promotion queued for the external curator.',
  'designLibrary.promotions.failed': 'Promotion failed.',
  'guidedCreate.subtitle': 'A few quick questions — every one is optional.',
  'guidedCreate.stepIndicator': 'Step {current} of {total}',
  'guidedCreate.step.scope.title': 'Scope',
  'guidedCreate.step.content.title': 'Content',
  'guidedCreate.step.direction.title': 'Direction',
  'guidedCreate.screensLabel': 'How many screens?',
  'guidedCreate.screensCustomPlaceholder': 'Custom',
  'guidedCreate.fidelityLabel': 'Fidelity level',
  'guidedCreate.fidelity.wireframe': 'Wireframe',
  'guidedCreate.fidelity.cleanPrototype': 'Clean prototype',
  'guidedCreate.fidelity.highFidelity': 'High-fidelity, polished',
  'guidedCreate.iterationsLabel': 'How many variations?',
  'guidedCreate.pagesLabel': 'Which pages or flows are required?',
  'guidedCreate.pagesPlaceholder': 'Other pages, comma-separated',
  'guidedCreate.chip.home': 'Home',
  'guidedCreate.chip.pricing': 'Pricing',
  'guidedCreate.chip.about': 'About',
  'guidedCreate.chip.dashboard': 'Dashboard',
  'guidedCreate.chip.onboarding': 'Onboarding',
  'guidedCreate.chip.settings': 'Settings',
  'guidedCreate.chip.checkout': 'Checkout',
  'guidedCreate.productLabel': 'Product',
  'guidedCreate.productPlaceholder': 'What are you building?',
  'guidedCreate.audienceLabel': 'Audience',
  'guidedCreate.audiencePlaceholder': 'Who is it for?',
  'guidedCreate.useCaseLabel': 'Core use case',
  'guidedCreate.useCasePlaceholder': 'What should someone be able to do?',
  'guidedCreate.directionLabel': 'Brand, content, and visual direction',
  'guidedCreate.directionPlaceholder': 'Tone, colors, references, anything to know',
  'guidedCreate.matchKitLook': "Match the kit's own look",
  'guidedCreate.back': 'Back',
  'guidedCreate.next': 'Next',
  'guidedCreate.skipAll': 'Skip all',
  'guidedCreate.start': 'Start',
  'guidedCreate.starting': 'Starting…',
  ...
  'storyboard.shotCountOne': '{count} shot',
  'storyboard.back': 'Back to storyboards',
  'storyboard.titleLabel': 'Storyboard name',
  'storyboard.ratio': 'Ratio',
  'storyboard.styleReference': 'Style reference',
  'storyboard.styleReferenceActive': 'Style: {name}',
  'storyboard.styleReferenceHint':
    'Paste DESIGN.md content and every generated frame, mood draft, and shot render will steer toward its palette, typography, and mood. Your shot prompts always come first.',
  'storyboard.styleReferencePlaceholder': '---\nname: Heritage\ncolors:\n  accent: "#8a5a2b"\n---\n# Heritage\n…',
  ...
  'storyboard.assembleDone': 'Assembled {file}',
  'storyboard.exportSlider': 'Export web slider',
  'storyboard.exporting': 'Exporting…',
  'storyboard.exportDone': 'Exported {file}',
  'storyboard.openFolder': 'Open output folder',
  'storyboard.renderFailed': 'Render failed',
  'storyboard.moodLaneTitle': 'Mood exploration',
  'storyboard.moodLaneHelper': 'Cheap 480p sketches to find the mood — not final quality.',
  'storyboard.moodPromptPlaceholder': 'Describe the overall mood and motion to explore…',
  'storyboard.moodGenerate': 'Generate sketch',
  'storyboard.rendering': 'Rendering…',
  'storyboard.shotLabel': 'Shot {number}',
  'storyboard.moveShotUp': 'Move shot earlier',
  'storyboard.moveShotDown': 'Move shot later',
  'storyboard.duplicateShot': 'Duplicate shot',
  'storyboard.deleteShot': 'Delete shot',
  'storyboard.startFrame': 'Start frame',
  'storyboard.endFrame': 'End frame',
  'storyboard.iterate': 'Iterate',
  'storyboard.replace': 'Replace',
  'storyboard.generate': 'Generate',
  'storyboard.usePreviousEndFrame': "Use previous shot's end frame",
  'storyboard.startPromptPlaceholder': 'Describe the starting image…',
  ...
  'storyboard.shotsHeading': 'Shots',
  'storyboard.emptyShotsHelper': 'Pick a starting point — from a template, a quick brief, or a blank shot.',
  'storyboard.moreWaysToStart': 'More ways to start',
  'storyboard.templateSectionLabel': 'Start from a template',
  'storyboard.template.panLeft': 'Pan left',
  'storyboard.template.panLeftPrompt': 'the camera pans left slowly while the subject stays centered and in focus',
  'storyboard.template.slowZoomIn': 'Slow zoom-in',
  'storyboard.template.slowZoomInPrompt': 'the camera slowly pushes in on the subject, tightening the frame',
  'storyboard.briefSectionLabel': 'Start from a brief',
  'storyboard.briefPlaceholder': 'Describe the shot in a sentence or two…',
  'storyboard.briefCreateShot': 'Create shot',
  'storyboard.draftShotCountLabel': 'Shots',
  'storyboard.draftStoryboard': 'Draft storyboard',
  'storyboard.draftingStoryboard': 'Drafting…',
  'storyboard.draftPartial': 'Drafted {drafted} of {requested} shots. Try a more detailed brief to fill in the rest.',
  'storyboard.blankSectionLabel': 'Start blank',
  'storyboard.noMotionPromptYet': 'No motion prompt yet',
  'storyboard.retry': 'Retry',
  'storyboard.statusQueued': 'Queued',
  'storyboard.statusDone': 'Done',
  'storyboard.statusFailed': 'Failed',
  'storyboard.detailsToggle': 'Edit',
  'storyboard.closeDetails': 'Close details',
  'storyboard.fixInDetails': 'Fix in details',
  'storyboard.addStartFrame': '+ Start',
  'storyboard.addEndFrame': '+ End',
  'storyboard.moodLaneTeaser': 'Cheap 480p sketches',
  'storyboard.flowHint': '1 · add a shot  →  2 · set frames & motion  →  3 · Render',
  'storyboard.keyframesHeading': 'Keyframes',
  'storyboard.uploadConstraintHint': 'PNG, JPEG, or WebP · up to 16 MB',
  'storyboard.parametersHeading': 'Parameters',
  'storyboard.settingsHeading': 'Settings',
  'storyboard.previousShot': 'Previous shot',
  'storyboard.nextShot': 'Next shot',
  'storyboard.selectShotHint': 'Select a shot to see its details here.',
  'storyboard.rowActionsMenu': 'Shot actions',
  'storyboard.startDialogTitle': 'Start a storyboard',
  'storyboard.startDialogIntro': 'Answer five creative questions. MishMash will set up the shot plan; you can change everything afterward.',
  'storyboard.recipeRecommended': 'Recommended',
  'storyboard.recipeHeroTitle': 'Hero product commercial',
  'storyboard.recipeHeroDescription': 'A focused four-shot ad for one product, one audience, and one promise.',
  'storyboard.recipeHeroBadge': 'Hero commercial',
  'storyboard.recipeStepImages': 'Add product images',
  'storyboard.recipeStepTakes': 'Generate a few takes',
  'storyboard.recipeStepChoose': 'Choose the best take for each shot',
  'storyboard.recipeStepAssemble': 'Assemble the final video',
  'storyboard.briefProduct': 'Product or service name',
  'storyboard.briefAudience': 'Who is it for?',
  'storyboard.briefPromise': 'One promise to make',
  'storyboard.briefDirection': 'How should it feel?',
  'storyboard.briefCta': 'What should viewers do next?',
  'storyboard.briefRatio': 'Video shape',
  'storyboard.ratioLandscape': 'Landscape',
  'storyboard.ratioVertical': 'Vertical',
  'storyboard.ratioSquare': 'Square',
  'storyboard.createCommercial': 'Create commercial',
  'storyboard.creating': 'Creating…',
  'storyboard.startBlankInstead': 'Start blank instead',
  'storyboard.commercialFlow': '1 · add product images  →  2 · generate takes  →  3 · choose favorites  →  4 · assemble',
  'storyboard.takesHeading': 'Takes',
  'storyboard.takeLabel': 'Take {number}',
  'storyboard.takeProviderLabel': 'Provider',
  'storyboard.takeDurationLabel': 'Render time',
  'storyboard.usageRightsUnverified': 'Usage rights not verified — check provider terms before client delivery.',
  'storyboard.useTake': 'Use this take',
  'storyboard.rejectTake': 'Reject take',
  'storyboard.takeApproved': 'Approved for final video',
  'storyboard.takeApprovedNotSelected': 'Approved earlier · not selected',
  'storyboard.takeRejected': 'Rejected',
  'storyboard.takeProviderNote': 'Provider note',
  'storyboard.takeWarnings': 'Provider warnings',
  'storyboard.comparisonNotes': 'Add comparison notes',
  'storyboard.brandFit': 'Brand fit',
  'storyboard.motionQuality': 'Motion quality',
  'storyboard.artifactControl': 'Visual cleanliness',
  ...
  'interview.intro': 'Pick how much time your client has. Every length still collects the essentials — a shorter interview asks for less, never less reliably.',
  'interview.resuming': 'Resuming your interview…',
  'interview.tier.quick.name': 'Quick',
  'interview.tier.quick.duration': '5-10 minutes',
  'interview.tier.quick.description': 'The essentials only: location, service area, certifications, contact info, services, ideal customer, and look and feel.',
  'interview.tier.standard.name': 'Standard',
  'interview.tier.standard.duration': '15-20 minutes',
  'interview.tier.standard.description': 'Everything in Quick, plus target customer detail, existing assets, and site content.',
  'interview.tier.full.name': 'Full',
  'interview.tier.full.duration': '25-30 minutes',
  'interview.tier.full.description': 'The complete interview: FAQ content and site structure and logistics as well.',
  'interview.progress': 'Question {current} of {total}',
  'interview.status.complete': 'All required information collected.',
  'interview.status.needsInfo': 'Some required information is still missing — you can start the project anyway, or go back and fill it in.',
  'interview.openItems.title': 'Open items',
  'interview.projectName.label': 'Project name',
  'interview.defaultProjectName': 'New client project',
  'interview.forceIncomplete.label': 'Start the project anyway, even though required information is missing',
  'interview.startProject': 'Start project from this brief',
  'interview.error.start': 'Could not start the interview. Please try again.',
  'interview.error.turn': 'Could not save that answer. Please try again.',
  'interview.error.resume': 'Could not resume this interview.',
  'interview.error.startProject': 'Could not start a project from this brief.',
};
