...
'settings.memoryRemoveTypeFilterLabel': string;
  ...
  'entry.academyLoading': string;
  'entry.academyUnavailable': string;
  ...
  'chat.runError.title.cliOutdated': string;
  'chat.runError.title.attachmentUnsupported': string;
  'chat.runError.title.requestRejected': string;
  'chat.runError.title.toolFailed': string;
  'chat.runError.title.agentDidNotStart': string;
  'chat.runError.title.agentStopped': string;
  ...
  'chat.runError.step.modelSelect': string;
  'chat.runError.step.promptSend': string;
  'chat.runError.step.firstTokenWait': string;
  'chat.runError.step.toolExecution': string;
  'chat.runError.step.artifactWrite': string;
  'chat.runError.step.childClose': string;
  'chat.runError.step.finalize': string;
  ...
  'storyboard.shotsHeading': string;
  'storyboard.emptyShotsHelper': string;
  'storyboard.moreWaysToStart': string;
  'storyboard.templateSectionLabel': string;
  'storyboard.template.panLeft': string;
  'storyboard.template.panLeftPrompt': string;
  'storyboard.template.slowZoomIn': string;
  'storyboard.template.slowZoomInPrompt': string;
  ...
  'storyboard.statusQueued': string;
  'storyboard.statusDone': string;
  'storyboard.statusFailed': string;
  'storyboard.detailsToggle': string;
  'storyboard.closeDetails': string;
  'storyboard.fixInDetails': string;
  'storyboard.addStartFrame': string;
  'storyboard.addEndFrame': string;
  ...
  'storyboard.startDialogTitle': string;
  'storyboard.startDialogIntro': string;
  'storyboard.recipeRecommended': string;
  'storyboard.recipeHeroTitle': string;
  'storyboard.recipeHeroDescription': string;
  'storyboard.recipeHeroBadge': string;
  'storyboard.recipeStepImages': string;
  'storyboard.recipeStepTakes': string;
  'storyboard.recipeStepChoose': string;
  'storyboard.recipeStepAssemble': string;
  'storyboard.briefProduct': string;
  'storyboard.briefAudience': string;
  'storyboard.briefPromise': string;
  'storyboard.briefDirection': string;
  'storyboard.briefCta': string;
  'storyboard.briefRatio': string;
  'storyboard.ratioLandscape': string;
  'storyboard.ratioVertical': string;
  'storyboard.ratioSquare': string;
  'storyboard.createCommercial': string;
  'storyboard.creating': string;
  'storyboard.startBlankInstead': string;
  'storyboard.commercialFlow': string;
  'storyboard.takesHeading': string;
  'storyboard.takeLabel': string;
  'storyboard.takeProviderLabel': string;
  'storyboard.takeDurationLabel': string;
  'storyboard.usageRightsUnverified': string;
  'storyboard.useTake': string;
  'storyboard.rejectTake': string;
  'storyboard.takeApproved': string;
  'storyboard.takeApprovedNotSelected': string;
  'storyboard.takeRejected': string;
  'storyboard.takeProviderNote': string;
  'storyboard.takeWarnings': string;
  'storyboard.comparisonNotes': string;
  'storyboard.brandFit': string;
  'storyboard.motionQuality': string;
  'storyboard.artifactControl': string;
