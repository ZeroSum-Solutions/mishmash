  ...
  return (
    <section ref={homeHeroRef} className="home-hero" data-testid="home-hero">
      <div className="home-hero__brand" aria-hidden>
        ...
        <span className="home-hero__brand-name">MishMash</span>
      </div>
...
function fallbackPlaceholderScenarioText(
  ...
  // Open Design ships English-only; the zh/ja variants of this template were
  // removed in the de-bloat pass. `locale` stays on the signature so callers
...
// Open Design ships English-only; the zh/ja artifact-label variants were
// removed in the de-bloat pass. `kind` stays on the signature so callers
// don't need to change.
