...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as a MishMash plugin so I can install it into My plugins and open a PR to the MishMash community catalog.',
  '',
