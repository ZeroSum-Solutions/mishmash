...
// Open Design ships English-only; the non-English Excalidraw lang-code
// mappings were removed in the de-bloat pass.
...
// Open Design ships English-only; the zh-CN/zh-TW DOM text-override tables
// for Excalidraw's own UI strings were removed in the de-bloat pass. `locale`
// stays on the signature so `applySketchDomI18nOverrides` and the Close-label
// lookup below don't need to change.
