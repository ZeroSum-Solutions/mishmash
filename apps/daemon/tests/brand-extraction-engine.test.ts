...
describe('agent-driven brand extraction engine', () => {
  ...
  it('prefers source-backed human brand tokens over script/debug color noise', () => {
    const brand = brandFromMaterial({
      ...
      siteName: 'Acme Design',
      title: 'Acme Design',
      description: 'Acme Design design system.',
      colors: [
      ...
      fontFiles: [],
      logos: [],
      headings: ['Acme Design The Open-source Claude Design alternative'],
      paragraphs: ['Acme Design is a local-first design platform.'],
      navLabels: [],
      extraPages: [],
      screenshot: null,
      thin: false,
