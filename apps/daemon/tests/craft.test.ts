...
describe('resolveRequestedCraft', () => {
  ...
  it('design-system exemptions also win over the floor', () => {
    ...
    expect(r).toEqual(['typography', 'color', 'composition', 'accessibility-baseline']);
  });

  it('the floor is small and defensible: exactly typography, color, anti-ai-slop, composition, accessibility-baseline', () => {
