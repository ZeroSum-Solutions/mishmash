...
<html lang="en">
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="MishMash">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">MishMash</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in MishMash.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to MishMash.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to MishMash.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to MishMash.';
        }
