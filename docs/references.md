...
- **What we don't:**
  - **Electron as the product runtime** — our product UI remains the shared Next.js web app; this fork removed its Electron desktop/packaged host (`apps/desktop`, `apps/packaged`) and uses the web Studio only.
