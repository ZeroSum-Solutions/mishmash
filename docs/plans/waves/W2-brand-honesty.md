...
| C2-10 | `human:` Internal-identifier ruling recorded | `docs/decisions/internal-identifiers.md` states the founder's ruling and rationale. `blocked-on-founder`; both auditors recommend **keep** |
