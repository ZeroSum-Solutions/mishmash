# MishMash Web Clipper — Privacy Policy

_Last updated: 2026-07-26_

**Short version: the MishMash Web Clipper does not collect, store, or transmit
your data to us or to any third party. Everything you clip goes only to the
MishMash app running on your own computer.**
...
viewing and sends it to the MishMash application running locally on your own
...
Nothing. The developer (MishMash / wiggdevin) operates **no servers** that
...
- **Access to websites you clip (`<all_urls>`)** — to read and screenshot the
  ...
  reach your local MishMash app. The extension acts only on the page you
...
- **Context menus** — the right-click "Save image to MishMash Library" entry.
...
All captured content is stored by the MishMash app in its local Library on your
device. Managing, exporting, or deleting that content is done inside the MishMash
app. Uninstalling the extension removes its local preferences.
...
Questions: https://github.com/wiggdevin/mishmash/issues
