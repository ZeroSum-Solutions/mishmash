// MishMash web clipper popup. Thin UI over the service worker message API.
//
// Zero-config: no pairing. The popup just probes whether MishMash is running
...
function render(connected) {
  ...
  // "MishMash not running" message instead of being hidden, so it never feels broken.
}
