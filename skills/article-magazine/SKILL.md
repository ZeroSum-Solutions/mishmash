...
category: article
scenario: marketing
aspect_hint: "A4 / long-scroll page"
featured: 11
...
example_desc: "An extended commentary on 'in the AI era, HTML > Markdown', with the original tweet annotated and clickable links"
...
- H2 / H3 headings use a serif font, giving visual contrast against the body text.
- Blockquotes use a thick accent-colored left border + italic.
...
- Sections separated by `<hr>`, styled as a small centered ornament.
- End with a simple "if you found this useful, please share" call-to-action card.
